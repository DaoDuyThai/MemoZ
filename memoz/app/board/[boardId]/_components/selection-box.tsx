...
export const SelectionBox = memo(({
    ...
    const soldeLayerId = useSelf((me) => me.presence.selection.length === 1 ? me.presence.selection[0] : null)

    const isShowingHandles = useStorage((root) =>
        soldeLayerId && root.layers.get(soldeLayerId)?.type !== LayerType.Path
    )
